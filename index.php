        ...
        <div class="wrapper">
            ...
            <div class="login-box">
                <div class="login-box-inner">
                    <h1>S'identifier</h1>
                    <?php
                    if(strpos($_SERVER['REQUEST_URI'], "error=email"))
                    {
                        echo'<h1 style="font-size: 15px;color: #8B0000"> <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Désolé, nous avons pas trouvé de compte avec cette adresse e-mail. </h1> <br>';
                    }
                    ?>
                    <form action="actions/login.php" method="post"> 
                        <div class="form-group">
                            <input type="text" name="email" placeholder="Email ou numéro de téléphone" required>
                        </div>
                        <div class="form-group">
